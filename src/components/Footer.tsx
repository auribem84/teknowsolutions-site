        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><button onClick={scrollToTop} className={navLinkProps.className}>Home</button></li>
              <li><ScrollLink to="about" {...navLinkProps}>About Us</ScrollLink></li>
              <li><ScrollLink to="services" {...navLinkProps}>Services</ScrollLink></li>
              <li><ScrollLink to="contact" {...navLinkProps}>Contact</ScrollLink></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><ScrollLink to="services" {...navLinkProps}>Infrastructure</ScrollLink></li>
              <li><ScrollLink to="services" {...navLinkProps}>Cloud & DevOps</ScrollLink></li>
              <li><ScrollLink to="services" {...navLinkProps}>Security & Compliance</ScrollLink></li>
              <li><ScrollLink to="services" {...navLinkProps}>Process Automation</ScrollLink></li>
              <li><ScrollLink to="services" {...navLinkProps}>App Development</ScrollLink></li>
            </ul>
          </div>
